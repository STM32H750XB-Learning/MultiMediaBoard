...
#define SYS_STAT_THREAD_PRIO       	30
...
{
	EXECUTION_TIME total_time, idle_time, delta_to_time, delta_to_idle_time;
	...
	{		
		...
		delta_to_time = _tx_execution_thread_time_total + _tx_execution_isr_time_total + _tx_execution_idle_time_total - total_time;
		cpu_usage = (double)delta_to_idle_time/delta_to_time;
